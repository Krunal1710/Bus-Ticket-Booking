...
// Check if the seat selected is already booked
$sql_check_seat = "SELECT * FROM bookings WHERE seat = '$seat' AND bdate='$date' AND bus_number='$selected_bus_number'";
...
// Insert booking details into a new table in the database
